...
var FiveBox = (_temp2 = _class = function (_Taro$Component) {
  ...
  function FiveBox() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = FiveBox.__proto__ || Object.getPrototypeOf(FiveBox)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["loopArray12", "styles", "list", "ImgError"], _this.customComponents = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(FiveBox, [{
    ...
    value: function _createData() {
      ...
      var loopArray12 = list.map(function (v, idx) {
        v = {
