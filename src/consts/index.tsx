...
successAudio.src =
  'https://img.tukuppt.com/newpreview_music/09/00/70/5c89440055a9b76614.mp3'
successAudio.onError(errCallback)

// 错误点击音效的实例
const errorAudio = Taro.createInnerAudioContext()
errorAudio.src =
  'https://img.tukuppt.com/newpreview_music/09/00/74/5c8949d63547e84016.mp3'
errorAudio.onError(errCallback)

// 通关音效的实例
const passAudio = Taro.createInnerAudioContext()
passAudio.src =
  'https://img.tukuppt.com/newpreview_music/09/00/55/5c893391ee55466803.mp3'
passAudio.onError(errCallback)

const fomatOffset = (percentage: number) => `calc(${percentage}% - 15px)`
