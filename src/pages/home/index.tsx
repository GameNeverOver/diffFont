...
import Taro, { FC, useState, useContext } from '@tarojs/taro'
...
const Index: FC = () => {
  const { maxLevel, effectMode, setEffectMode } = useContext($Store)
  ...
  return (
    <View className={styles.indexPage}>
      ...
      <View className={styles.options}>
        ...
        <View
          onClick={() => Taro.navigateTo({ url: '/pages/chooseLevel/index' })}
        >
          <Image src={imgChoose} />
          选关
        </View>
